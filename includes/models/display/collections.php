<?php
	...
	isset($_POST['pp_BOOK'])?$pp_BOOK = $_POST['pp_BOOK']:$pp_BOOK='';
...
<div id="books">
    ...
    <tr>
            ...
            <table style="text-align:center;"><caption>Tri</caption>
                    ...
                    <tr>
                            ...
                            <td><select name="pp_ORDER">
							   ...
							   <option value="booktitle" <?php if ($pp_ORDER=='booktitle'){echo 'selected';} ?>>Livre</option>
                            </select></td>
                    </tr>
                    <tr>
            ...
            <table style="text-align:center;"><caption>Recherche</caption>
					...
					<tr>
                            <td>Livre :</td>
                            <td><input type="text" name="pp_BOOK" value="<?php echo $pp_BOOK ?>"/></td>
                    </tr>
                    <tr>
                            <td colspan="2">
...
<?php
	...
	if (isset($_POST['REF'])){	
		if ($_POST['MODE']=='S'){
			...
			$a->deleteCollection($_POST['REF']);
		}
		else if ($_POST['MODE']=='M'){
			//echo 'demande modif : '.$_POST['REF'];
			$a->updateCollection($_POST['REF'],$_POST['title'],$_POST['pages'],$_POST['book']);
		}
	}
