                ...
                <tr>
                    <td>            
                        <div id="in"><div id="logo"></div>
                            ...
                            <div class="clr"></div>
                            <div class="clr"></div>
                            <div id="resultAdd"><?php
                                if (isset($_POST['MODE']) && $_POST['MODE'] == 'I') {
                                    echo "qdfqsdfqsdf";
                                    //echo $_POST['type_add'];
                                    //if ($_POST['type_add'] == 'article') {
                                        echo '151515151515155';
                                        require_once "includes/bean/articles.php";
                                        $a = new articles("includes/xml/article.xml");
                                        /*$search['key_add'] = $_POST['key_add'];
                                        $search['mdate_add'] = $_POST['mdate_add'];
                                        $search['title'] = $_POST['r_author'];
                                        $search['page'] = $_POST['r_author'];
                                        $search['year'] = $_POST['r_author'];
                                        $search['volume'] = $_POST['r_author'];
                                        $search['journal'] = $_POST['r_author'];
                                        $search['url'] = $_POST['r_author'];
                                        $search['ee'] = $_POST['r_author'];*/
                                        $search['key_add'] = "abc";
                                        $search['mdate_add'] = "abc";
                                        $search['title'] = "abc";
                                        $search['page'] = "abc";
                                        $search['year'] = "abc";
                                        $search['volume'] = "abc";
                                        ...
                                        echo $search['key_add'];
                                        echo '<br/>';
                                        echo $search['mdate_add'];echo '<br/>';
                                        echo $search['title'];echo '<br/>';
                                        echo $search['page'];echo '<br/>';
                                        echo $search['year'];echo '<br/>';
                                        echo $search['volume'];echo '<br/>';
                                        echo $search['journal'];echo '<br/>';
                                        echo $search['ee'];echo '<br/>';
                                        echo $search['url'];

                                        $a->addArticle($search['key_add'], $search['mdate_add'], $search['title'], $search['author'], $search['page'], $search['year'], $search['volume'],$search['journal'], $search['url'], $search['ee']);
